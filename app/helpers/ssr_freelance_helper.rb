module SsrFreelanceHelper
  ...
  def status_select
    arr = []
    id_status = Setting.plugin_freelance_helper['sunstrike_freelance_field_status'].to_i
    if id_status > 0
  ...
  def self.mark_custom_field_freelance
    ...
    if Setting.plugin_freelance_helper['sunstrike_freelance_field_status'].to_i != -10 and
        Setting.plugin_freelance_helper['sunstrike_freelance_field_status'].to_i > 0
      a << CustomField.where(type: 'IssueCustomField').find(Setting.plugin_freelance_helper['sunstrike_freelance_field_status'].to_i)
    end
